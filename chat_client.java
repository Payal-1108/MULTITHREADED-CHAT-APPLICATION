...
public class chat_client<tatic> extends javax.swing.JFrame{
	/**
	 * 
	 */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
         ...
         try {
            ...
            s1 = new Socket("127.0.0.1",1201); // ip address is of localhost because server is running on the same mschine
